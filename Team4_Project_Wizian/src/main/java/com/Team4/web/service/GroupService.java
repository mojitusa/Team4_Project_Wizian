...
public class GroupService {
    ...
    public int insertRegister(String pRGRM_NM, String sCHDL_BGNG_YMD, String sCHDL_END_YMD, String gC_DT, int nOPE,
        String pRGRM_TYPE, String gC_OG_NM, String counselingContent, String posterContent, String userNumber, String fileUrl) {
        ...
        registerInfo.put("fileUrl", fileUrl); // 파일 URL 추가
